...
| `--api-key` value                   | (empty)                                | Provide an API key for server-side authentication as an admin user.                                                                                                                                                                                                                                                                            |
| `--server-port` value               | `30080`                                | Target port of the OriginHub API server for applying or listing runtime config. When omitted, defaults to `GPUSTACK_API_PORT` if set, otherwise `30080`.                                                                                                                                                                                        |
| `--worker-port` value               | `10150`                                | Target port of the OriginHub worker for applying or listing runtime config. When omitted, defaults to `GPUSTACK_WORKER_PORT` if set, otherwise `10150`.                                                                                                                                                                                         |
